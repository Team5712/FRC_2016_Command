...
public class OI {
	...
	public OI() {
		...
		solenoidOut_DriveStickButton.whenPressed(new SolenoidMove(false)); // false = out
		solenoidIn_DriveStickButton = new JoystickButton(driveStick, RobotMap.SOLENOID_IN_BUTTON);
		solenoidIn_DriveStickButton.whenPressed(new SolenoidMove(true)); // true = in
		...
		solenoidOut_ShootStickButton = new JoystickButton(shootStick, RobotMap.SOLENOID_IN_BUTTON_2);
		solenoidOut_ShootStickButton.whenPressed(new SolenoidMove(false));
		solenoidIn_ShootStickButton = new JoystickButton(shootStick, RobotMap.SOLENOID_OUT_BUTTON_2);
